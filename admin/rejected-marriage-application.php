...
<html lang="en">
  <head>
    ...
    <title>Online Marriage Registration System || Rejected Marriage Application</title>
...
include_once('includes/sidebar.php');
 ...
 ?>
    ...
    <div class="am-pagetitle">
      <h5 class="am-title">Rejected Marriage Application</h5>
    ...
    <div class="am-mainpanel">
      <div class="am-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Rejected Marriage Application</h6>
